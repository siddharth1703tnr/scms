                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control shadow-none" name="primaryMobile" id="registerTechnicianPrimaryMobile" autocomplete="off" pattern="[0-9]{10}" required>
                                                    <div class="invalid-feedback">Please enter a valid 10-digit mobile number.</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="registerTechnicianSecondaryMobile" class="form-label">Secondary Mobile No</label>
                                                    <input type="text" class="form-control shadow-none" name="secondaryMobile" id="registerTechnicianSecondaryMobile" autocomplete="off" pattern="[0-9]{10}" required>
                                                    <div class="invalid-feedback">Please enter a valid 10-digit mobile number.</div>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control shadow-none" name="primaryMobile" id="technicianPrimaryMobile" pattern="[0-9]{10}" required>
                                                    <div class="invalid-feedback">Please enter a valid 10-digit mobile number.</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="technicianSecondaryMobile" class="form-label">Secondary Mobile No</label>
                                                    <input type="text" class="form-control shadow-none" name="secondaryMobile" id="technicianSecondaryMobile" pattern="[0-9]{10}" required>
                                                    <div class="invalid-feedback">Please enter a valid 10-digit mobile number.</div>
                                                </div>
                                                <div class="col-md-6">
    ...
    $(document).ready(function() {
        ...
        $('#technicianTable').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                url: '../../controllers/Technician/ajax/fetchTechnicians.php',
                method: 'POST',
                data: { action: 'getById', id: technicianId },
                dataType: 'json',
                success: function(response) {
