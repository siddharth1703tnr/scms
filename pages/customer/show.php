    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="card card-warning card-outline">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="ml-auto">
                                ...
                                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#customerModal">
        ...
        <script>
            $(document).ready(function() {
                ...
                // Show modal for updating a customer
                function showUpdateModal(customer) {
                    ...
                    $('#customerWhatsApp').val(customer.whatsapp);
                    $('#customerProductCompany').val(customer.productCompany);
                    $('#customerProductModel').val(customer.productModel);
                    $('#customerLastMessageSendDate').val(customer.lastMessageSendDate);
