...
$dealerCredentials = new Credentials($db);
...
try {
    ...
    } elseif ($action == 'getDealerById') {
        $id = isset($_SESSION['distributor_id']) ? $_SESSION['distributor_id'] : '';
        $dealerDataById = $dealerCredentials->getDealerById($id);
